...
class QuizAdapterForNotify(val context: Context, val quizzes: List<Quiz>) :
    RecyclerView.Adapter<QuizAdapterForNotify.QuizViewHolder>() {
    ...
    override fun onBindViewHolder(holder: QuizViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val msg = quiz.selectedDateTime?.let { dt ->
                formatRemainingTime(dt, "yyyy-MM-dd hh:mm a")
            } ?: "Unknown start time"
